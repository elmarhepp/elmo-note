    ...
    <div class="auth-card">
      ...
      <form @submit.prevent="submit">
        <div class="form-group">
          <label>Name</label>
          <input v-model="name" type="text" placeholder="Dein Name" required autofocus />
        </div>
        <div class="form-group">
          <label>E-Mail</label>
        ...
        <div class="form-group">
          ...
          <input v-model="password" type="password" placeholder="Min. 8 Zeichen" required />
        </div>
        <div class="form-group">
...
async function submit() {
  ...
  try {
    ...
    error.value = errors ? Object.values(errors).flat().join(' ') : 'Registrierung fehlgeschlagen.'
  } finally {
    loading.value = false
  }
}
